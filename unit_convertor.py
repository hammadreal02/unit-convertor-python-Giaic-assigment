...
#category select
category = st.selectbox("Select a Category",["📏length","⌚Time","⚖️ Weight","🌡Temperature",'🧪 Volume',"⚖️ Mass","🏃‍♂️ Speed"] )

# input numbers for convert
value = st.number_input("Enter a number to convert", value=0 , min_value=0)
...
# if category selected speed  
    ...
    units={ 
        ...
        "kilometer per hour Km/h": 1000.0 / 3600.0,  # 1km/h = 0.27778
    ...
    st.success(f'{value} {from_units} = {result:.3f} {To_units}')    
